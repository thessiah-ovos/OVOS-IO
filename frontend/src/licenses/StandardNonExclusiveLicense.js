...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Standard Licensing (Non-Exclusive)</title>
    <style media="screen">
  ...
  <body>
    <h1>Standard Non-Exclusive (SNX) Licensing Agreement</h1>
    <hr>
...
<!-- MASTER USE-->
      ...
      <li> <b>MASTER USE.</b>
        <ol>
          <li type="a"> <p>The Licensor herby grants to the Licensee a <b>Standard Non-Exclusive License</b> to record vocal synchronization to the instrumental partly or in its entirety and substantially in its original form (hereinafter referred to as the “Master Recording”).</p></li>
        </ol>
      </li>
...
<!-- OWNERSHIP-->
      ...
      <li><b>PAYMENT TERMS.</b> <p></p><ol>
        ...
        <li type="a">The Licensee will pay the Licensor a sum of <b>USD Forty Nine Dollars and Ninety Nine Cents ($49.99)</b> for the Standard Non-Exclusive License.</li>
    ...
    <!-- CREDIT -->
      ...
      <li><b>GENERAL TERMS.</b>
        <ol><p></p>
          <li type="a">The Licensor reserves the right to issue any other License to the use of the Instrumental that is the subject of this agreement, to any other third party/parties as it wishes. </li>
          <li type="a">The Licensor also reserves the right to assign its copyright in the Instrumental that is the subject of this License to any third party as it wishes. </li>
          <li type="a">In the event that another License to use the Instrumental is issued by the Licensor, or the Licensor has assigned its copyright in the said Master Recording, the terms of this agreement shall be upheld and the Licensee’s rights shall remain in effect for the remaining term of this License whereby the Instrumental or Master Recording is still the Licensee’s to use in accordance with the terms herein. </li>
        </ol>
      </li><br>
...
<!-- MECHANICAL RIGHTS -->
      ...
      <li>MECHANICAL RIGHTS.
        <ol><p></p>
          ...
          <li type="a">The Licensor hereby grants to Licensee the right to use the Master Recording for one (1) commercial release. </li>
          <li type="a">The Licensee is given the right to the reproduction, duplication, manufacture, and distribution of phonograph records, cassette tapes, compact disks, internet downloads, other and miscellaneous audio and digital recordings, and any lifts and versions thereof (collectively, “Recordings”) worldwide for up to the pressing or selling a total of one thousand (1000) copies of such Recordings or any combination of such Recordings.  </li>
          <li type="a">The Licensee can receive up to fifty thousand (50,000) paid streams on audio streaming services/platforms including but not limited to Spotify, Rhapsody, and Apple Music. </li>
      ...
      <li>PERFORMING RIGHTS.
        <ol><p></p>
          ...
          <li type="a">The Licensee is permitted to earn up to five hundred ($500.00) US Dollars in compensation or ticket sales using the Master Recording in said performances. </li>
          <li type="a">The Licensee agrees to submit a report to the Licensor every three quarters nine (9) months after the effective date to show sales report from worldwide sales, streaming services and live shows or concerts. </li>
        </ol><br>
...
<!-- SYNCH -->
      ...
      <li><b>SYNCHRONIZTION RIGHTS.</b>
        <ol><p></p>
          ...
          <li type="a">The Licensee can use the Master Recording in synchronization or timed relation with the production in  <b>one (1) </b> project. </li>
          <li type="a">The Licensee can receive up to <b>one hundred thousand (100,000) total</b> non-monetized YouTube plays for videos that the instrumental is included in. </li>
          <li type="a">The Licensee is strictly prohibited from monetizing and/or collecting royalties from the use of the Instrumental from synchronization, including but not limited to YouTube or related video streaming services. </li>
...
<!-- ELECTRICAL -->
      ...
      <li><b>ELECTRICAL TRANSCRIPTION RIGHTS.</b>
        <ol><p></p>
          <li type="a">The Licensor hereby grants Licensee the right to broadcast or air the Master Recording on one (1) radio station or through one (1) station channel, respectively.</li>
        </ol><br>
...
<!-- LICENSE DURATION -->
      ...
      <li><b>DURATION OF LICENSE</b>
        <ol> <p></p>
          <li type="a">This Licensing agreement is to be effective as for all intents and purposes, as of the Effective Date and shall expire in <b>one (1) year</b>.</li>
        </ol><br>
      </li>
        ...
        <ol><p></p>
          <li type="a">Licensee hereby agrees and acknowledges that he/she/they are expressly prohibited from taking any action(s) and from engaging in any use of the Instrumental or Master Recording in the manners, or for the purposes, set forth below:
            <ol>
              ...
              <li type="i">The Licensee shall not synchronize, or permit third parties to synchronize, the Instrumental or Master Recording with any audio-visual works EXCEPT as expressly provided for and pursuant to clause 8(b) of this Agreement for use in two (2) Video. This restriction includes, but is not limited to, use of Instrumental and/or Master Recording in television, commercials, film/movies, theatrical works, video games, and in any other form on the internet which is not expressly permitted herein. </li>
...
<!-- SPECIFICATIONS -->
      ...
      <li><b>SPECIFICATIONS.</b>
        <ol><p></p>
          <li type="a">The Licensor agrees to deliver the sound recording of the Instrumental as a high-quality <b>MP3 & WAV stereo files with no TRACK-STEMS</b>, as such terms are understood in the music industry. </li>
...
function StandardNonExclusiveLicense(props) {
...
export default StandardNonExclusiveLicense;
