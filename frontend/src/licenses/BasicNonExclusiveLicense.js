...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Basic Licensing (Non-Exclusive)</title>
    <style media="screen">
  ...
  <body>
    <h1>Basic Non-Exclusive (BNX) Licensing Agreement</h1>
    <hr>
...
<!-- MASTER USE-->
      ...
      <li> <b>MASTER USE.</b>
        <ol>
          <li type="a"> <p>The Licensor herby grants to the Licensee a <b>Basic Non-Exclusive License</b> to record vocal synchronization to the instrumental partly or in its entirety and substantially in its original form (hereinafter referred to as the “Master Recording”).</p></li>
        </ol>
      </li>
...
<!-- OWNERSHIP-->
      ...
      <li><b>PAYMENT TERMS.</b> <p></p><ol>
        ...
        <li type="a">The Licensee will pay the Licensor a sum of <b>USD Twenty Nine Dollars and Ninety Nine Cents ($29.99)</b> for the Basic Non-Exclusive License.</li>
...
<!-- MECHANICAL RIGHTS -->
      ...
      <li>MECHANICAL RIGHTS.
        <ol><p></p>
          <li type="a">The Master Recording may be used for <b>promotional purposes</b> ONLY, including but not limited to, a release in a single format, for inclusion in a mixtape or free compilation of music bundled together (EP or album), and/or promotional, non-monetized digital streaming.</li>
      ...
      <li>PERFORMING RIGHTS.
        <ol><p></p>
          ...
          <li type="a">The Licensee is NOT permitted to earn any monies in compensation or ticket sales using the Master Recording in said performances.  </li>
        </ol><br>
...
<!-- SYNCH -->
      ...
      <li><b>SYNCHRONIZTION RIGHTS.</b>
        <ol><p></p>
          ...
          <li type="a">The Licensee can use the Master Recording in synchronization or timed relation with the production in  <b>zero (0)</b> project. </li>
          <li type="a">The Licensee can receive up to <b>zero (0) total</b> non-monetized YouTube plays for videos that the instrumental is included in. </li>
          <li type="a">The Licensee can receive up to <b>zero (0) total</b> non-monetized streams collectively from video streaming platforms including but not limited to YouTube, Netflix and Vevo etc. </li>
...
<!-- ELECTRICAL -->
      ...
      <li><b>ELECTRICAL TRANSCRIPTION RIGHTS.</b>
        <ol><p></p>
          <li type="a">The Licensor hereby grants Licensee the right to broadcast or air the Master Recording on <b>one (1)</b> radio station. </li>
        </ol><br>
        ...
        <ol><p></p>
          <li type="a">Licensee hereby agrees and acknowledges that he/she/they are expressly prohibited from taking any action(s) and from engaging in any use of the Instrumental or Master Recording in the manners, or for the purposes, set forth below:
            <ol>
              ...
              <li type="i">The Licensee shall not synchronize, or permit third parties to synchronize, the Instrumental or Master Recording with any audio-visual works. This restriction includes, but is not limited to, use of Instrumental and/or Master Recording in television, commercials, film/movies, theatrical works, video games, and in any other form on the internet which is not expressly permitted herein. </li>
...
<!-- SPECIFICATIONS -->
      ...
      <li><b>SPECIFICATIONS.</b>
        <ol><p></p>
          <li type="a">The Licensor agrees to deliver the sound recording of the Instrumental as a high-quality <b>MP3 stereo file with no TRACK-STEMS</b>, as such terms are understood in the music industry. </li>
...
const BasicNonExclusiveLicense = () => (
  <div>
    { <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(rawHTML) }} /> }
  </div>
)

export default BasicNonExclusiveLicense;
