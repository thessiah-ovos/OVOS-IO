...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Pro Unlimited Licensing (Non-Exclusive)</title>
    <style media="screen">
  ...
  <body>
    <h1>Pro Unlimited Non-Exclusive (PU) Licensing Agreement</h1>
    <hr>
...
<!-- OWNERSHIP-->
      ...
      <li><b>PAYMENT TERMS.</b> <p></p><ol>
        ...
        <li type="a">The Licensee will pay the Licensor a sum of <b>USD Two Hundred and Ninety Nine Dollars and Ninety Nine Cents ($299.99)</b> for the Premium Non-Exclusive License.</li>
...
<!-- LICENSE DURATION -->
      ...
      <li><b>DURATION OF LICENSE</b>
        <ol> <p></p>
          <li type="a">This Licensing agreement is to be effective as for all intents and purposes, as of the Effective Date and shall expire in <b>three (3) years</b>.</li>
        </ol><br>
      </li>
...
<label for="nosignature"> I Do Not Agree</label><br>
</div>
...
function ProUnlimitedNonExclusiveLicense(props) {
...
export default ProUnlimitedNonExclusiveLicense;
